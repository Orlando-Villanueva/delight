...
*Note: For detailed development commands, UI design tokens, and git conventions, see `AGENTS.md`.*
...
3.  **Database & Data:**
    ...
    ```
    *Note: The seeder populates the base Bible structure and a rich set of dummy data for development.*
