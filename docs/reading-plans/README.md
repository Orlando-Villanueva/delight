...
3. Verify `/plans/today` shows the correct Day 1 reading
...
| -------------------- | ------------------------ | ---- | -------------------------------------- |
| `standard-canonical` | Read the Bible in a Year | 365  | Canonical order, Genesis to Revelation |
...
-   Check `reading_plan_subscriptions.current_day` value
-   Verify `reading_logs` table has entries for each chapter
