...
return [
    'books' => array_combine(range(1, 73), [
        ...
        'Luc', 'Jean', 'Actes', 'Romains', '1 Corinthiens', '2 Corinthiens',
        ...
        '1 Jean', '2 Jean', '3 Jean', 'Jude', 'Apocalypse', 'Tobie',
        'Judith', 'Sagesse', 'Siracide', 'Baruch', '1 Maccabées',
        '2 Maccabées',
    ]),
