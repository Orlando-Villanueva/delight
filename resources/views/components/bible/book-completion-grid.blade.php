    ...
    <div class="p-6 lg:p-4 xl:p-6">
        <div x-data="bookProgressComponent(@js($oldData), @js($newData), @js($testament))" x-init="initialize()">
            ...
            <div {{ $testament === 'New' ? 'x-cloak' : '' }}>
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3 overflow-hidden">
                        <div class="bg-primary-500 h-3 rounded-full transition-[width] duration-500 ease-in-out"
                            x-ref="progressBar" style="width: 0%"></div>
                    </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
                    <template x-for="book in current.processed_books" :key="book.name">
                        <div class="relative p-3 rounded-lg border-2 text-center transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer group"
                            ...
                            <!-- Book Name -->
                            <div class="font-semibold text-sm mb-1 truncate leading-[1.5]" x-text="book.name"></div>
                            ...
                            <template x-if="book.status === 'completed'">
                                <div
                                    class="absolute -top-1 -right-1 w-4 h-4 bg-success-500 rounded-full flex items-center justify-center">
                ...
                <!-- Legend -->
                <div
                    class="flex items-center justify-center space-x-6 mt-6 pt-4 border-t border-gray-300 dark:border-gray-600">
                    ...
                    <div class="flex items-center space-x-2">
                        <div
                            class="w-3 h-3 bg-white dark:bg-gray-800 rounded border-2 border-gray-300 dark:border-gray-600">
                        </div>
