    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-gray-50 rounded-lg shadow dark:bg-[#2f3746]">
            ...
            <div class="p-4 md:p-5 border-b border-gray-200/80 rounded-t-lg bg-white dark:bg-[#2f3746] dark:border-white/10">
                <h3 id="delete-title-{{ $log->id }}" class="text-lg font-semibold text-gray-900 dark:text-white">
                    Delete this reading?
                </h3>
            ...
            {{-- Modal body --}}
            <div class="p-4 md:p-5 text-center space-y-4 bg-gray-50 dark:bg-[#2f3746]">
                <svg class="mx-auto text-red-600 dark:text-red-500 w-12 h-12" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
                <p id="delete-desc-{{ $log->id }}" class="text-sm text-gray-500 dark:text-gray-400">
                    This action cannot be undone.
                </p>
            </div>

            {{-- Action buttons --}}
            <div class="js-delete-actions-{{ $log->id }} flex flex-col-reverse gap-3 sm:flex-row sm:justify-center p-4 md:p-5 border-t border-gray-200/80 rounded-b-lg bg-gray-50 dark:bg-[#2f3746] dark:border-white/10">
