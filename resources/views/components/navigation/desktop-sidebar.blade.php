        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('recap.show') }}"
                    class="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group transition-colors">
                    ...
                    <span class="ms-3">Annual Recap</span>
                </a>
            </li>
        </ul>
    </div>
