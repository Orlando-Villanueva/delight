...
@php
    ...
    // Check if we should show reading plan CTA instead of regular log reading
    $showPlanCta = $planCta['showPlanCta'] ?? false;
@endphp
            ...
            <div class="flex flex-wrap items-start justify-between gap-3">
                ...
                @if (($status['state'] ?? null) === 'perfect')
                    <output
                        ...
                        @if ($status['showCrown'])
                            <svg class="w-5 h-5 text-amber-500" viewBox="0 0 640 640" fill="currentColor"
                                aria-hidden="true">
                                <path
                ...
                @foreach ($journeyDays as $index => $day)
                    @php
                        ...
                        $stateClasses = [
                            ...
                            WeeklyJourneyDayState::MISSED->value =>
                                'bg-destructive-100 dark:bg-destructive-900/40 border-destructive-200 dark:border-destructive-700',
                        ...
                        $segmentStateClass =
                            $stateClasses[$state] ?? $stateClasses[WeeklyJourneyDayState::UPCOMING->value];
