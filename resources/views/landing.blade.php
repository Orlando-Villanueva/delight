...
<head>
    ...
    <meta property="og:image" content="{{ asset('images/screenshots/link-preview-v2.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('images/screenshots/link-preview-v2.png') }}">
