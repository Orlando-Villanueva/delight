<div id="feedback-form-container"
    ...
    <form action="{{ route('feedback.store') }}" method="POST" class="space-y-6" hx-post="{{ route('feedback.store') }}"
        ...
        <div class="flex flex-col sm:flex-row sm:justify-end">
            <button type="submit"
                class="w-full sm:w-auto text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Send Feedback
            </button>
        </div>
    </form>
