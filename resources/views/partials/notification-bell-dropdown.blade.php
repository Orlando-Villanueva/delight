<div
    class="block px-4 py-3 font-semibold text-center text-gray-700 bg-gray-50 dark:bg-gray-800 dark:text-white rounded-t-lg border-b border-gray-100 dark:border-gray-700 text-xs uppercase tracking-widest">
    Notifications
</div>
...
<div class="divide-y divide-gray-100 dark:divide-gray-700 max-h-96 overflow-y-auto">
    @forelse($announcements as $announcement)
        ...
        <a href="{{ route('announcements.show', $announcement->slug) }}"
            class="flex px-4 py-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
            ...
            <div class="w-full ps-3">
                <div
                    class="text-gray-600 dark:text-gray-400 text-sm mb-1.5 {{ $isUnread ? 'font-semibold text-gray-900 dark:text-white' : '' }}">
                    {{ $announcement->title }}
                </div>
    ...
    @empty
        <div class="px-4 py-8 text-center bg-white dark:bg-gray-800">
...
<a href="{{ route('announcements.index') }}"
    class="block py-3 text-xs font-semibold text-center text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white rounded-b-lg border-t border-gray-100 dark:border-gray-700 transition-colors">
